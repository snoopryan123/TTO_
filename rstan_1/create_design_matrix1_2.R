...
output_filename = "design_matrix1_2.csv" #FIXME
...
D7 <- D6 %>% mutate(std_EVENT_WOBA_19 = std(EVENT_WOBA_19),
                    std_WOBA_FINAL_BAT_19 = std(WOBA_FINAL_BAT_19),
                    std_WOBA_FINAL_PIT_19 = std(WOBA_FINAL_PIT_19))

# select relevant columns
D8 <- D7 %>% select(std_EVENT_WOBA_19, std_WOBA_FINAL_BAT_19, std_WOBA_FINAL_PIT_19,
                   EVENT_WOBA_19, WOBA_FINAL_BAT_19, WOBA_FINAL_PIT_19,
                   BATTER_IDX, ORDER_CT,
                   HAND_MATCH, BAT_HOME_IND, IN_DIV)
