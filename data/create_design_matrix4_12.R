...
### same as create_design_matrix4_11.R except with new column FIRST_SZN, indicating
###### that it's a player's first season 

input_filename = "TTO_dataset_410.csv" #FIXME
output_filename = "TTO_dataset_412.csv" #FIXME
