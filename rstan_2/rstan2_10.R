...
# ORDER_CT x std_WOBA_FINAL_BAT_19 interaction terms
intr1 = D$std_WOBA_FINAL_BAT_19 * ORDER_CT_dummies
...
plot1 = A4 %>% 
  ...
  labs(title = paste0(OUTPUT_FILE, " interaction: bat_woba x ORDER_CT ")) +
