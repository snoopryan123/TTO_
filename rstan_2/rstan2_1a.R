...
### SAME AS rstan2_1.R, EXCEPT WITH 4000 ITERATIONS INSTEAD OF 2000

OUTPUT_FILE = "rstan2_1a.R" #FIXME
NUM_ITERS_IN_CHAIN = 4000 #FIXME #10 
...
X <- bind_cols(X, D %>% select(std_WOBA_FINAL_BAT_19, std_WOBA_FINAL_PIT_19, HAND_MATCH, BAT_HOME_IND))
