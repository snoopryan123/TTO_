...
etas = tibble(
  eta1 = c(0.95, 1.73, 0.487, 0.88, 1.92, 1.72),
  eta2 = c(1.2, 1.99, 1.06, 1.35, 3.01, 1.85),
  eta3 = c(-0.27, 0.068, 0.010, -0.10, -0.30, -0.13),
...
#            do.call(cbind, replicate(9, gamma[,3], simplify=FALSE)),
