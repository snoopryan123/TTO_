...
fit_3a <- readRDS("../rstan_3a/job_output/fit_rstan3_overall_bsn1.R.rds")
fit_3b <- readRDS("./job_output/fit_rstan3_overall_bsn1.R.rds")

p_3a = plot_bsn0(fit_3a)
p_3b = plot_bsn0(fit_3b)
p_3a
p_3b
